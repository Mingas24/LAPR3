...
public class ShortestPathControllerTest {
    ...
    public void testShortestPath2Parks() {
        ...
        ShortestPathsController instance = new ShortestPathsController();
    ...
    public void testShortestPathPOI() {
        ...
        Route result = instance.shortestPath2ParksPOIS(source, dest, poiList, testGraph);
        ...
        result = instance.shortestPath2ParksPOIS(source, dest, poiList, testGraph);
        ...
        result = instance.shortestPath2ParksPOIS(source, dest, poiList, testGraphCal);
        ...
        result = instance.shortestPath2ParksPOIS(source, dest, poiList, testGraphEnergy);
