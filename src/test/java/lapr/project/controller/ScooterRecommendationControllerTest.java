 ...
 * @author Utilizador
 */
public class ScooterRecommendationControllerTest {

    private final Graph<Location, Double> testGraphEnergy;
    private final List<Location> locationList = new ArrayList<>();
    private final ScooterRecommendationController instance = new ScooterRecommendationController();
    ...
    public ScooterRecommendationControllerTest() throws IOException, SQLException{
 ...
 */
    ...
    public void recommendateScooterTest() throws IOException, SQLException {
        ...
        poiList.add(poi2);
        sdb.ClearDatabase();
        Scooter emptyScooter = new Scooter();
