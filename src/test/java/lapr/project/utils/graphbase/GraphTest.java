...
public class GraphTest {
    ...
    public void testOutgoingEdges() {
        ...
        assertTrue(
                ...
                || (first.getElement().equals("Edge5") == true && second.getElement().equals("Edge4") == true)), "Outgoing Edges of vert C should be Edge4 and Edge5");
    ...
    public void testClone() {
        ...
        Graph<String, String> instClone = new Graph<>(instance);//instance.clone();
    ...
    public void testEquals() {
        ...
        Graph<String, String> anotherCopy = new Graph<>(instance);
        assertTrue(instance.equals(anotherCopy), "should be equal to a clone");
        //assertTrue(instance.equals(instance.clone()), "should be equal to a clone");

        Graph<String, String> other = new Graph<>(instance);// instance.clone();
    ...
    public void testToString() {
        assertEquals("Graph not defined", instance.toString());
